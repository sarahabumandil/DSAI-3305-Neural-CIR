...
class NaiveBayes(object):
    ...
    def train(self, x: csr_matrix, y: numpy.array):
        """
...
def main():
    if len(sys.argv) != 3:
        print(f"Usage: python3 {sys.argv[0]} <train-input> <test-input>")
        exit(1)
    ...
    # TODO: Print the 20 words with the highest p_wc values per class which do
